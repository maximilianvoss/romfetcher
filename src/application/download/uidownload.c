...
static void renderTitle(app_t *app) {
    ...
    texture_t texture;
    rendering_loadText(app->sdlRenderer, &texture, app->search.active->title, app->themes.active->fonts.font34,
...
static void renderStartButton(app_t *app) {
    ...
    texture_t texture;
    rendering_loadText(app->sdlRenderer, &texture, "Download", app->themes.active->fonts.font34,
...
static void renderCancelButton(app_t *app) {
    ...
    texture_t texture;
    rendering_loadText(app->sdlRenderer, &texture, "Cancel", app->themes.active->fonts.font34,
                       &app->themes.active->colors.text);
