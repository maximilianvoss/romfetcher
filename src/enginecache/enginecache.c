...
static void deleteTimestamp(app_t *app, rl_hoster *hoster, rl_system *system);

static void insertTimestamp(app_t *app, rl_hoster *hoster, rl_system *system);
...
acll_t *enginecache_getSearchResults(rl_hoster *hoster, rl_system *system, char *searchString, void *data) {
    ...
    while (ret == SQLITE_ROW) {
        ...
        resultList = acll_append(resultList, item);
