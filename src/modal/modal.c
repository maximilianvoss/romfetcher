...
static void renderHeadline(app_t *app) {
    ...
    texture_t texture;
    rendering_loadText(app->sdlRenderer, &texture, app->modal.headline, getActiveTheme(app)->fonts.font34,
                       &getActiveTheme(app)->colors.modalHeadText);
...
static void renderText(app_t *app) {
    ...
    texture_t texture;
    rendering_loadText(app->sdlRenderer, &texture, app->modal.text, getActiveTheme(app)->fonts.font26,
                       &getActiveTheme(app)->colors.modalText);
...
static void renderActionButton(app_t *app) {
    ...
    texture_t texture;
    rendering_loadText(app->sdlRenderer, &texture, app->modal.actionButton, getActiveTheme(app)->fonts.font26,
                       app->modal.cursorPos ? &getActiveTheme(app)->colors.modalButtonTextInactive
                                            : &getActiveTheme(app)->colors.modalButtonTextActive);
...
static void renderCancelButton(app_t *app) {
    if (app->modal.cancelButton != NULL) {
        ...
        texture_t texture;
        rendering_loadText(app->sdlRenderer, &texture, app->modal.cancelButton, getActiveTheme(app)->fonts.font26,
                           !app->modal.cursorPos ? &getActiveTheme(app)->colors.modalButtonTextInactive
                                                 : &getActiveTheme(app)->colors.modalButtonTextActive);
